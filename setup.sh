...
echo ""
echo "Quick start:"
echo "  1. Copy .env.example → .env and set OLLAMA_API_KEY / OPENAI_API_KEY"
echo "     VLLM_BASE_URL=https://ollama.com/v1"
echo "     DEFAULT_MODEL=gpt-oss:20b"
echo "  2. ./start-all.sh   (Windows: .\\setup.ps1 then .\\start-all.ps1)"
